import unittest
from positivity_check.positivity_check import Afinn
...
class TestPositivityCheck(unittest.TestCase):
    ...
    def test_find_AFINN(self):
        afinn_obj = Afinn()
        self.assertEqual(type(afinn_obj), Afinn)
    ...
    def test_word_lists(self):
        ...
        test_object = UserText("Hate, love, can't, won't, neutral, none, table, love, great, almost")
